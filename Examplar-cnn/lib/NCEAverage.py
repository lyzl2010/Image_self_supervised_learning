...
class NCEFunction(Function):
    ...
    def forward(self, x, y, memory, idx, params):
        ...
        weight = memory.index_select(0, idx.view(-1))
        ...
        self.save_for_backward(x, y, memory, weight, out, params)
        #self.data_for_backward = memory, weight, out, params
    ...
    def backward(self, gradOutput):
        ...
        return Variable(gradInput), None, None, None, None
