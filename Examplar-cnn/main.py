...
def main():
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        try:            
            ...
            #torch.save(model.state_dict(), os.path.join( 'model/', 'model-{}.ckpt'.format(epoch)))
    ...
    for i, (input, _, index) in enumerate(train_loader):
            ...
            if i % args.print_freq == 0:
                print('Epoch: [{}][{}/{}]'
                      ...
                      epoch, i, len(train_loader), batch_time=batch_time.val, data_time=data_time.val, train_loss=loss.item()))
